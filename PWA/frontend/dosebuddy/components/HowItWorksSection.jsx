      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our smart pill dispenser makes medication management simple and
            error-free. Follow these easy steps to ensure you never miss a dose
            again.
          </p>
        </div>
              ...
              >
                <div className="step-card hover:shadow-md transition-shadow group">
                  <div className="flex items-start gap-4">
                    <div
                      className={`${step.color} rounded-full p-3 flex-shrink-0 group-hover:scale-110 transition-transform`}
                    >
                      {step.icon}
                    </div>
                    <div>
                      <h3 className="text-xl font-bold mb-2 flex items-center">
                        <span
                          className={`${step.color} text-white w-6 h-6 rounded-full flex items-center justify-center text-sm mr-2`}
                        >
                          {step.id}
                        </span>
                        {step.title}
