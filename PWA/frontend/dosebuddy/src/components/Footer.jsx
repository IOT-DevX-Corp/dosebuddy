    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#testimonials" className="hover:text-medical-300 transition-colors">Testimonials</a></li>
              <li><a href="#contact" className="hover:text-medical-300 transition-colors">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-medical-300 transition-colors">API Reference</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
          <p>&copy; {new Date().getFullYear()} DoseBuddy. All rights reserved.</p>
          <div className="mt-4 md:mt-0">
            <a href="#" className="hover:text-medical-300 transition-colors mr-4">Privacy</a>
            <a href="#" className="hover:text-medical-300 transition-colors mr-4">Terms</a>
            <a href="#" className="hover:text-medical-300 transition-colors">Sitemap</a>
          </div>
        </div>
      </div>
    </footer>
